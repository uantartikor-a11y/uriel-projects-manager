...
# רישום גופן עברית מתוך הרפוזיטורי
FONT_PATH = "Heebo-VariableFont_wght.ttf"
try:
    if os.path.exists(FONT_PATH):
        pdfmetrics.registerFont(TTFont("HebrewArial", FONT_PATH))
    else:
        fallback_font = os.path.join(os.environ.get("SystemRoot", "C:\\Windows"), "Fonts\\arial.ttf")
        pdfmetrics.registerFont(TTFont("HebrewArial", fallback_font))
except Exception:
    pass
